...
main = tkinter.Tk()
main.title("Agricultural Crop Recommendation Based on productivity and season")
...
font = ('times', 15, 'bold')
title = Label(main, text='Agricultural Crop  Recommendation Based on Productivity and Season', justify=LEFT)
...
ffButton = Button(main, text="Run Passive Aggressive Algorithm", command=runPAC)
